...
exports.responseByProxy = void 0;
const config_1 = require("../config");
const utils_1 = require("../utils/utils");
const request_1 = require("./request");
function responseByProxy(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        responseHeaders[`${config_1.bproxyPrefixHeader}-host`] = matcherResult.rule.proxy;
        return (0, request_1.responseByRequest)(req, res, requestOptions, responseHeaders, matcherResult, config, postBodyData);
    });
}
exports.responseByProxy = responseByProxy;
