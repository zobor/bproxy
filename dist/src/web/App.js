...
exports.default = () => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (historyContext) {
            try {
                ...
                Object.keys(data).filter((key) => key !== 'requestId').forEach((key) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "app", id: "app" }, { children: (0, jsx_runtime_1.jsx)(ctx_1.Ctx.Provider, Object.assign({ value: { state, dispatch } }, { children: (0, jsx_runtime_1.jsx)(react_router_dom_1.HashRouter, { children: (0, jsx_runtime_1.jsx)(react_router_dom_1.Switch, { children: routerList.map((routerConfig) => (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, { exact: true, path: routerConfig.routerPath, component: LazyLoadComponent(routerConfig.Component, routerConfig.name) }, routerConfig.path)) }, void 0) }, void 0) }), void 0) }), void 0));
};
