...
const Detail = (props) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        detail && setTimeout(() => {
            var _a, _b;
            if (detail.responseHeaders && ((_a = detail.responseHeaders['content-type']) === null || _a === void 0 ? void 0 : _a.includes('image/'))) {
                ...
                if (detail.custom.method === 'ws') {
                    ...
                    let body = (0, buffer_1.buffer2string)(detail.responseBody, detail.responseHeaders && detail.responseHeaders['content-encoding']);
    ...
    const cookies = detailActiveTab === 'requestHeaders' && ((_a = detail === null || detail === void 0 ? void 0 : detail.requestHeaders) === null || _a === void 0 ? void 0 : _a.cookie) ? detail.requestHeaders.cookie.split('; ') : [];
    (0, react_1.useEffect)(() => {
        if (!showDetail) {
            setShowBody('');
        }
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: `detail ${showDetail ? 'open' : ''}` }, { children: [(0, jsx_runtime_1.jsx)("div", { className: "mask", onClick: onClose }, void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "content" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: "url", onClick: openUrl.bind(null, custom.url) }, { children: custom ? `${custom.statusCode || 'Pendding'} ${custom.method} ${custom.origin}${custom.path}` : '' }), void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "tabs" }, { children: (0, jsx_runtime_1.jsx)("ul", { children: custom && tabList.map((tab) => {
                            ...
                            }) }, void 0) }), void 0), detailActiveTab !== 'responseBody' ? (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "form scrollbar-style" }, { children: [detail && detail[detailActiveTab] ? Object.keys(detail[detailActiveTab]).map(key => ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "form-item" }, { children: [(0, jsx_runtime_1.jsxs)("label", { children: [key, ":"] }, void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "form-item-value" }, { children: detail[detailActiveTab][key].toString() }), void 0)] }), key))) : null, (0, jsx_runtime_1.jsx)(CookiesView, { cookies: cookies }, void 0)] }), void 0) : null, detailActiveTab === 'responseBody' ? (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "body-panel scrollbar-style" }, { children: showBody || '不支持预览' }), void 0) : null] }), void 0)] }), void 0));
};
