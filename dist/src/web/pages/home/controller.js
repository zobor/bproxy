...
const SystemProxy_1 = __importDefault(require("../../components/SystemProxy"));
...
const SystemProxylModal = ({ visible, onClose }) => {
    return (0, jsx_runtime_1.jsx)(modal_1.default, Object.assign({ onCancel: onClose, visible: visible, width: 1000, footer: null, destroyOnClose: true, title: "\u7CFB\u7EDF\u4EE3\u7406\u5F00\u5173" }, { children: (0, jsx_runtime_1.jsx)(SystemProxy_1.default, {}, void 0) }), void 0);
};
const Disconnected = () => (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "disconnected" }, { children: "bproxy \u5DF2\u7ECF\u505C\u6B62\u5DE5\u4F5C\uFF0C\u7B49\u5F85\u8FDE\u63A5\u4E2D..." }), void 0);
const Controller = (props) => {
    ...
    const { state: isShowSystemProxy, toggle: toggleShowSystemProxy } = (0, useBool_1.default)(false);
    ...
    if (!connected) {
        return (0, jsx_runtime_1.jsx)(Disconnected, {}, void 0);
    }
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "controller" }, { children: [(0, jsx_runtime_1.jsxs)("div", Object.assign({ onClick: toggleSwitch, className: (0, classnames_1.default)({
                ...
                }) }, { children: [(0, jsx_runtime_1.jsx)(icons_1.FilterOutlined, {}, void 0), (0, jsx_runtime_1.jsx)("span", { children: "\u8FC7\u6EE4\u89C4\u5219" }, void 0)] }), void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ onClick: toggleShowSystemProxy }, { children: [(0, jsx_runtime_1.jsx)(icons_1.MacCommandOutlined, {}, void 0), (0, jsx_runtime_1.jsx)("span", { children: "\u7CFB\u7EDF\u4EE3\u7406" }, void 0)] }), void 0), (0, jsx_runtime_1.jsx)(RuleTestModal, { onClose: toggleShowRuleTest, visible: isShowRuleTest }, void 0), (0, jsx_runtime_1.jsx)(FilterModal, { onClose: toggleShowFilter, visible: isShowFilter }, void 0), (0, jsx_runtime_1.jsx)(InstallModal, { onClose: toggleShowInstall, visible: isShowInstall }, void 0), (0, jsx_runtime_1.jsx)(SystemProxylModal, { onClose: toggleShowSystemProxy, visible: isShowSystemProxy }, void 0)] }), void 0));
};
