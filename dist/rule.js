...
var require_lodash = __commonJS((exports2, module2) => {
  ...
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      var Array2 = context.Array, Date = context.Date, Error = context.Error, Function2 = context.Function, Math2 = context.Math, Object2 = context.Object, RegExp2 = context.RegExp, String = context.String, TypeError2 = context.TypeError;
...
// src/rule.ts
__export(exports, {
  rulesPattern: () => rulesPattern,
  url2regx: () => url2regx
});
var _ = __toModule(require_lodash());
var url2regx = (url) => {
  const newUrl = url.replace(/\./g, "\\.").replace(/\//g, "\\/").replace(/\*\*/g, "(\\S+)$").replace(/\*/g, "([^/]+)$");
  return new RegExp(newUrl);
};
var rulesPattern = (rules, url) => {
  const options = {
    delay: 0,
    matched: false,
    responseHeaders: {}
