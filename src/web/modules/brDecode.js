...
let makeBrotliDecode = () => {
  ...
  let INSERT_LENGTH_N_BITS = Int16Array.from([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04, 0x04, 0x05, 0x05, 0x06, 0x07, 0x08,
    0x09, 0x0a, 0x0c, 0x0e, 0x18,
  ]);
  /** @type {!Int16Array} */
  let COPY_LENGTH_N_BITS = Int16Array.from([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04, 0x04, 0x05, 0x05, 0x06,
    0x07, 0x08, 0x09, 0x0a, 0x18,
  ]);
  /** @type {!Int16Array} */
    ...
    while (s.runningState != 10) {
      switch (s.runningState) {
        ...
        case 4:
          ...
          s.copyLength =
            copyLengthOffset +
            (copyLengthExtraBits <= 16 ? readFewBits(s, copyLengthExtraBits) : readManyBits(s, copyLengthExtraBits));
          s.j = 0;
          s.runningState = 7;
        case 7:
 ...
 */
export const BrotliDecode = makeBrotliDecode();
